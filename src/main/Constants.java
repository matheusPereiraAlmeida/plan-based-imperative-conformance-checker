...
public class Constants {
	...
	private static PetriNetsPerspective pnPanel;
	...
	public static PetriNetsPerspective getPetriNetPerspective() {
		return pnPanel;
	}
	public static void setPetriNetPerspective(PetriNetsPerspective pnPanel) {
		Constants.pnPanel = pnPanel;
	}
