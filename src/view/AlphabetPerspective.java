...
public class AlphabetPerspective extends JPanel{
	...
	private void initComponent() {
		...
		this.setBorder(new TitledBorder(null, "STEP 1: Create a repository of activities to populate the event log", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		tasksPanel.setPreferredSize(new Dimension(260,100)); 
		tasksPanel.setLayout(new FlowLayout());

		taskField = new JTextField();
		taskField.setPreferredSize(new Dimension(260,30));
		...
		addTaskButtonPanel.setPreferredSize(new Dimension(120,100)); 
