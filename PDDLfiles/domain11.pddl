...
:effect (and (allowed) (not (token 951)) (token 924) (not (tracePointer ev6)) (tracePointer evEND))
)
...
:precondition (and (token 966) (tracePointer ev4))
:effect (and (allowed) (not (token 966)) (token 951) (not (tracePointer ev4)) (tracePointer ev5))
)
...
:precondition (and (token 949) (tracePointer ev3))
:effect (and (allowed) (not (token 949)) (token 965) (not (tracePointer ev3)) (tracePointer ev4))
)
...
:precondition (and (token 967) (tracePointer ev5))
:effect (and (allowed) (not (token 967)) (token 966) (not (tracePointer ev5)) (tracePointer ev6))
)
...
(:action moveInTheLog#activityb#ev6-evEND
