...
(:action moveSync#activityd#ev4
:precondition (and (token 965) (tracePointer ev4))
:effect (and (allowed) (not (token 965)) (token 967) (not (tracePointer ev4)) (tracePointer ev5))
)
...
(:action moveInTheLog#activityd#ev4-ev5
